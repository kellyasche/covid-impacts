...
hosp.cap.ruca.plot <- ggplot(hosp.cap.ruca, aes(collection_week, pct, color = Dem_Desc)) +
  ...
  labs(x="", y = "", color="", title = "Percent of beds by type", caption = "U.S. Department of Health & Human Services - COVID-19 Reported Patient Impact and Hospital Capacity by Facility")+
